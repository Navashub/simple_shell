...
**To better understand how the shell actually works, you can read our [Article](https://en.wikipedia.org/wiki/Unix_shell).**
...
````
git clone https://github.com/Navashub/simple_shell.git
````
...
* [Irene](https://github.com/irenegm2022)
* [Navas](https://github.com/Navashub/simple_shell)
